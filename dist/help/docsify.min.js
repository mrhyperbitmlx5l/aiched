! function() {
	...
	var f = document.body.clientWidth <= 600,
		i = window.history && window.history.pushState && window.history.replaceState && !navigator.userAgent.match(
		...
		if (n)
			for (var r in t)
				if (l.call(t, r)) {
					...
					c(i) && (t[r] = "" === i || i)
				} return !0 === t.loadSidebar && (t.loadSidebar = "_sidebar" + t.ext), !0 === t.loadNavbar && (t.loadNavbar =
				"_navbar" + t.ext), !0 === t.coverpage && (t.coverpage = "_coverpage" + t.ext), !0 === t.repo && (t.repo = ""), !0 ===
			t.name && (t.name = ""), window.$docsify = t
	}
	var T = /([^{]*?)\w(?=\})/g,
		E = {
			YYYY: "getFullYear",
	...
	var je = xe(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink",
			"blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content",
			"data", "datalist", "dd", "decorator", "del", "details", "dfn", "dir", "div", "dl", "dt", "element", "em",
			"fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header",
			"hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark",
			"marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre",
			"progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "shadow", "small", "source", "spacer",
		...
		De = xe(["svg", "a", "altglyph", "altglyphdef", "altglyphitem", "animatecolor", "animatemotion", "animatetransform",
			"audio", "canvas", "circle", "clippath", "defs", "desc", "ellipse", "filter", "font", "g", "glyph", "glyphref",
			"hkern", "image", "line", "lineargradient", "marker", "mask", "metadata", "mpath", "path", "pattern", "polygon",
			"polyline", "radialgradient", "rect", "stop", "style", "switch", "symbol", "text", "textpath", "title", "tref",
			"tspan", "video", "view", "vkern"
		]),
		He = xe(["feBlend", "feColorMatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting",
		...
		qe = xe(["math", "menclose", "merror", "mfenced", "mfrac", "mglyph", "mi", "mlabeledtr", "mmultiscripts", "mn", "mo",
			"mover", "mpadded", "mphantom", "mroot", "mrow", "ms", "mspace", "msqrt", "mstyle", "msub", "msup", "msubsup",
			"mtable", "mtd", "mtext", "mtr", "munder", "munderover"
		]),
		Ie = xe(["#text"]),
		Ue = xe(["accept", "action", "align", "alt", "autocomplete", "background", "bgcolor", "border", "cellpadding",
			"cellspacing", "checked", "cite", "class", "clear", "color", "cols", "colspan", "controls", "coords", "crossorigin",
			"datetime", "default", "dir", "disabled", "download", "enctype", "face", "for", "headers", "height", "hidden",
			"high", "href", "hreflang", "id", "integrity", "ismap", "label", "lang", "list", "loop", "low", "max", "maxlength",
			"media", "method", "min", "minlength", "multiple", "name", "noshade", "novalidate", "nowrap", "open", "optimum",
			"pattern", "placeholder", "poster", "preload", "pubdate", "radiogroup", "readonly", "rel", "required", "rev",
			"reversed", "role", "rows", "rowspan", "spellcheck", "scope", "selected", "shape", "size", "sizes", "span",
			"srclang", "start", "src", "srcset", "step", "style", "summary", "tabindex", "title", "type", "usemap", "valign",
			"value", "width", "xmlns"
		]),
		Be = xe(["accent-height", "accumulate", "additive", "alignment-baseline", "ascent", "attributename", "attributetype",
			"azimuth", "basefrequency", "baseline-shift", "begin", "bias", "by", "class", "clip", "clip-path", "clip-rule",
			"color", "color-interpolation", "color-interpolation-filters", "color-profile", "color-rendering", "cx", "cy", "d",
			"dx", "dy", "diffuseconstant", "direction", "display", "divisor", "dur", "edgemode", "elevation", "end", "fill",
			"fill-opacity", "fill-rule", "filter", "filterunits", "flood-color", "flood-opacity", "font-family", "font-size",
			"font-size-adjust", "font-stretch", "font-style", "font-variant", "font-weight", "fx", "fy", "g1", "g2",
			"glyph-name", "glyphref", "gradientunits", "gradienttransform", "height", "href", "id", "image-rendering", "in",
			"in2", "k", "k1", "k2", "k3", "k4", "kerning", "keypoints", "keysplines", "keytimes", "lang", "lengthadjust",
			"letter-spacing", "kernelmatrix", "kernelunitlength", "lighting-color", "local", "marker-end", "marker-mid",
			"marker-start", "markerheight", "markerunits", "markerwidth", "maskcontentunits", "maskunits", "max", "mask",
			"media", "method", "mode", "min", "name", "numoctaves", "offset", "operator", "opacity", "order", "orient",
			"orientation", "origin", "overflow", "paint-order", "path", "pathlength", "patterncontentunits", "patterntransform",
			"patternunits", "points", "preservealpha", "preserveaspectratio", "primitiveunits", "r", "rx", "ry", "radius",
			"refx", "refy", "repeatcount", "repeatdur", "restart", "result", "rotate", "scale", "seed", "shape-rendering",
			"specularconstant", "specularexponent", "spreadmethod", "stddeviation", "stitchtiles", "stop-color", "stop-opacity",
			"stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity",
			"stroke", "stroke-width", "style", "surfacescale", "tabindex", "targetx", "targety", "transform", "text-anchor",
			"text-decoration", "text-rendering", "textlength", "type", "u1", "u2", "unicode", "values", "viewbox", "visibility",
			"version", "vert-adv-y", "vert-origin-x", "vert-origin-y", "width", "word-spacing", "wrap", "writing-mode",
			"xchannelselector", "ychannelselector", "x", "x1", "x2", "xmlns", "y", "y1", "y2", "z", "zoomandpan"
		]),
		Ze = xe(["accent", "accentunder", "align", "bevelled", "close", "columnsalign", "columnlines", "columnspan",
			"denomalign", "depth", "dir", "display", "displaystyle", "encoding", "fence", "frame", "height", "href", "id",
			"largeop", "length", "linethickness", "lspace", "lquote", "mathbackground", "mathcolor", "mathsize", "mathvariant",
			"maxsize", "minsize", "movablelimits", "notation", "numalign", "open", "rowalign", "rowlines", "rowspacing",
			"rowspan", "rspace", "rquote", "scriptlevel", "scriptminsize", "scriptsizemultiplier", "selection", "separator",
			"separators", "stretchy", "subscriptshift", "supscriptshift", "symmetric", "voffset", "width", "xmlns"
		]),
	...
	var P, j, D = function t(e) {
		...
		if (d.version = "2.0.8", d.removed = [], !c || !c.document || 9 !== c.document.nodeType) return d.isSupported = !1,
			d;
		var u = c.document,
			o = !1,
			s = !1,
		...
		function L(e) {
			pe && pe === e || (e && "object" === (void 0 === e ? "undefined" : et(e)) || (e = {}), D = "ALLOWED_TAGS" in e ? ze({},
					e.ALLOWED_TAGS) : H, q = "ALLOWED_ATTR" in e ? ze({}, e.ALLOWED_ATTR) : I, ce = "ADD_URI_SAFE_ATTR" in e ? ze(Pe(
					ue), e.ADD_URI_SAFE_ATTR) : ue, U = "FORBID_TAGS" in e ? ze({}, e.FORBID_TAGS) : {}, B = "FORBID_ATTR" in e ? ze({},
					e.FORBID_ATTR) : {}, oe = "USE_PROFILES" in e && e.USE_PROFILES, Z = !1 !== e.ALLOW_ARIA_ATTR, W = !1 !== e.ALLOW_DATA_ATTR,
				G = e.ALLOW_UNKNOWN_PROTOCOLS || !1, Y = e.SAFE_FOR_JQUERY || !1, V = e.SAFE_FOR_TEMPLATES || !1, X = e.WHOLE_DOCUMENT ||
				!1, J = e.RETURN_DOM || !1, ee = e.RETURN_DOM_FRAGMENT || !1, te = e.RETURN_DOM_IMPORT || !1, ne = e.RETURN_TRUSTED_TYPE ||
				!1, Q = e.FORCE_BODY || !1, re = !1 !== e.SANITIZE_DOM, ie = !1 !== e.KEEP_CONTENT, ae = e.IN_PLACE || !1, j = e.ALLOWED_URI_REGEXP ||
				j, V && (W = !1), ee && (J = !0), oe && (D = ze({}, [].concat(tt(Ie))), q = [], !0 === oe.html && (ze(D, je), ze(
					q, Ue)), !0 === oe.svg && (ze(D, De), ze(q, Be), ze(q, We)), !0 === oe.svgFilters && (ze(D, He), ze(q, Be), ze(
					q, We)), !0 === oe.mathMl && (ze(D, qe), ze(q, Ze), ze(q, We))), e.ADD_TAGS && (D === H && (D = Pe(D)), ze(D, e.ADD_TAGS)),
				e.ADD_ATTR && (q === I && (q = Pe(q)), ze(q, e.ADD_ATTR)), e.ADD_URI_SAFE_ATTR && ze(ce, e.ADD_URI_SAFE_ATTR), ie &&
				(D["#text"] = !0), X && ze(D, ["html", "head", "body"]), D.table && (ze(D, ["tbody"]), delete U.tbody), xe && xe(
					e), pe = e)
		}
		...
		function F(e) {
			...
			return e && n && t.body.insertBefore(l.createTextNode(n), t.body.childNodes[0] || null), A.call(t, X ? "html" :
				"body")[0]
		}
		var O = Ge,
			$ = Ye,
			...
			ae = !1,
			oe = {},
			se = ze({}, ["annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn",
				"mo", "ms", "mtext", "noembed", "noframes", "plaintext", "script", "style", "svg", "template", "thead", "title",
				"video", "xmp"
			]),
			le = ze({}, ["audio", "video", "img", "source", "image"]),
			ce = null,
			ue = ze({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "summary", "title", "value",
				"style", "xmlns"
			]),
			pe = null,
		...
		function fe(e) {
			return "object" === (void 0 === h ? "undefined" : et(h)) ? e instanceof h : e && "object" === (void 0 === e ?
				"undefined" : et(e)) && "number" == typeof e.nodeType && "string" == typeof e.nodeName
		}
		...
		function me(e) {
			...
			if (ge("beforeSanitizeElements", e, null), function(e) {
					return !(e instanceof f || e instanceof g || "string" == typeof e.nodeName && "string" == typeof e.textContent &&
						"function" == typeof e.removeChild && e.attributes instanceof a && "function" == typeof e.removeAttribute &&
			...
			if (D[n] && !U[n]) return "noscript" === n && $e(/<\/noscript/i, e.innerHTML) ? (C(e), !0) : "noembed" === n && $e(
				/<\/noembed/i, e.innerHTML) ? (C(e), !0) : (!Y || e.firstElementChild || e.content && e.content.firstElementChild ||
				!$e(/</g, e.textContent) || (Te(d.removed, {
					element: e.cloneNode()
				}), e.innerHTML ? e.innerHTML = Re(e.innerHTML, /</g, "&lt;") : e.innerHTML = Re(e.textContent, /</g, "&lt;")),
				V && 3 === e.nodeType && (t = e.textContent, t = Re(t, O, " "), t = Re(t, $, " "), e.textContent !== t && (Te(d.removed, {
					element: e.cloneNode()
			...
			if (o) {
				...
				for (a = o.length; a--;) {
					var l = t = o[a],
						c = l.name,
						u = l.namespaceURI;
					if (n = Oe(t.value), r = Le(c), s.attrName = r, s.attrValue = n, s.keepAttr = !0, s.forceKeepAttr = void 0, ge(
							"uponSanitizeAttribute", e, s), n = s.attrValue, !s.forceKeepAttr) {
						if ("name" === r && "IMG" === e.nodeName && o.id) i = o.id, o = Ee(o, []), R("id", e), R(c, e), _e(o, i) > a &&
		...
		function be(e) {
			var t = void 0,
				n = he(e);
			for (ge("beforeSanitizeShadowDOM", e, null); t = n.nextNode();) ge("uponSanitizeShadowNode", t, null), me(t) || (t.content instanceof p &&
				be(t.content), ye(t));
		...
		return d.sanitize = function(e, t) {
			...
			else if (e instanceof h) 1 === (r = (n = F("\x3c!--\x3e")).ownerDocument.importNode(e, !0)).nodeType && "BODY" ===
				r.nodeName ? n = r : "HTML" === r.nodeName ? n = r : n.appendChild(r);
			else {
				if (!J && !V && !X && ne && -1 === e.indexOf("<")) return b ? b.createHTML(e) : e;
				if (!(n = F(e))) return J ? null : k
			}
			n && Q && C(n.firstChild);
			for (var s = he(ae ? e : n); i = s.nextNode();) 3 === i.nodeType && i === a || me(i) || (i.content instanceof p &&
				be(i.content), ye(i), a = i);
	...
	function H(e) {
		...
		P || function() {
			...
			}(), t = i ? 80 < (t = parseInt(P.style.width || 0, 10) + i) ? 80 : t : Math.floor(n / r * 100), P.style.opacity = 1,
			P.style.width = 95 <= t ? "100%" : t + "%", 95 <= t && (clearTimeout(j), j = setTimeout(function(e) {
	...
	var ce = (function(e, t, n) {
		...
		key: "begin",
		value: function() {
			return this.isRunning || this.next === this.end || (this.frame = window.requestAnimationFrame(this._tick.bind(
				this))), this
		}
	}, {
		key: "stop",
		value: function() {
			return window.cancelAnimationFrame(this.frame), this.isRunning = !1, this.frame = null, this.timeStart = null,
				this.next = null, this
		}
	}, {
		key: "on",
		...
		value: function(e) {
			...
			this.timeStart || (this.timeStart = e), this.timeElapsed = e - this.timeStart, this.next = this.ease(this.timeElapsed,
				this.start, this.end - this.start, this.duration), this._shouldTick(t) ? (this._emit("tick", this.tweener.getIntermediateValue(
				this.next)), this.frame = window.requestAnimationFrame(this._tick.bind(this))) : (this._emit("tick", this.tweener
				.getFinalValue()), this._emit("done", null))
		}
	}, {
		key: "_shouldTick",
		value: function(e) {
	...
	function ue() {
		...
		! function(e, t) {
			if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
		}(this, ue), this.duration = e.duration || 1e3, this.ease = e.easing || this._defaultEase, this.tweener = e.tweener ||
			new oe(e), this.start = this.tweener.start, this.end = this.tweener.end, this.frame = null, this.next = null, this.isRunning = !
			1, this.events = {}, this.direction = this.start < this.end ? "up" : "down"
	}
	var pe = {},
		de = !1,
		he = null,
	...
	function me(e) {
		if (fe) {
			for (var t, n = m(".sidebar"), r = b(".anchor"), i = y(n, ".sidebar-nav"), a = y(n, "li.active"), o = document.documentElement,
					s = (o && o.scrollTop || document.body.scrollTop) - ge, l = 0, c = r.length; l < c; l += 1) {
				var u = r[l];
				if (u.offsetTop > s) {
					t = t || u;
					break
			...
			if (t) {
				...
				if (p && p !== a && (a && a.classList.remove("active"), p.classList.add("active"), a = p, !de && v.classList.contains(
						"sticky"))) {
	...
	var it = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ?
	...
	var ot = at(function(v, e) {
		! function() {
			...
			function l(e) {
				this.tokens = [], this.tokens.links = Object.create(null), this.options = e || m.defaults, this.rules = b.normal,
					this.options.pedantic ? this.rules = b.pedantic : this.options.gfm && (this.rules = b.gfm)
			}
			b._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/, b._title =
				/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/, b.def = e(b.def).replace("label", b._label).replace(
					"title", b._title).getRegex(), b.bullet = /(?:[*+-]|\d{1,9}\.)/, b.item =
				/^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/, b.item = e(b.item, "gm").replace(/bull/g, b.bullet).getRegex(), b
				.list = e(b.list).replace(/bull/g, b.bullet).replace("hr",
					"\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def", "\\n+(?=" + b.def.source + ")")
				.getRegex(), b._tag =
				"address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",
				b._comment = /<!--(?!-?>)[\s\S]*?-->/, b.html = e(b.html, "i").replace("comment", b._comment).replace("tag", b._tag)
				.replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), b.paragraph =
				e(b._paragraph).replace("hr", b.hr).replace("heading", " {0,3}#{1,6} +").replace("|lheading", "").replace(
					"blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}|~{3,})[^`\\n]*\\n").replace("list",
					" {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|!--)").replace("tag", b
					._tag).getRegex(), b.blockquote = e(b.blockquote).replace("paragraph", b.paragraph).getRegex(), b.normal = h({},
					b), b.gfm = h({}, b.normal, {
					nptable: /^ *([^|\n ].*\|.*)\n *([-:]+ *\|[-| :]*)(?:\n((?:.*[^>\n ].*(?:\n|$))*)\n*|$)/,
					table: /^ *\|(.+)\n *\|?( *[-:]+[-| :]*)(?:\n((?: *[^>\n ].*(?:\n|$))*)\n*|$)/
					...
					paragraph: e(b.normal._paragraph).replace("hr", b.hr).replace("heading", " *#{1,6} *[^\n]").replace("lheading",
							b.lheading).replace("blockquote", " {0,3}>").replace("|fences", "").replace("|list", "").replace("|html", "")
						.getRegex()
					...
					for (e = e.replace(/^ +$/gm, ""); e;)
						...
						for (e = e.substring(i[0].length), l = {
								...
								start: g ? +a : "",
								loose: !1
							}, this.tokens.push(l), n = !(c = []), f = (i = i[0].match(this.rules.item)).length, d = 0; d < f; d++) p = (s =
							i[d]).length, ~(s = s.replace(/^ *([*+-]|\d+\.) */, "")).indexOf("\n ") && (p -= s.length, s = this.options.pedantic ?
							s.replace(/^ {1,4}/gm, "") : s.replace(new RegExp("^ {1," + p + "}", "gm"), "")), d !== f - 1 && (o = b.bullet
							.exec(i[d + 1])[0], (1 < a.length ? 1 === o.length : 1 < o.length || this.options.smartLists && o !== a) && (
								e = i.slice(d + 1).join("\n") + e, d = f - 1)), r = n || /\n\n(?!\s*$)/.test(s), d !== f - 1 && (n = "\n" ===
							s.charAt(s.length - 1), r = r || n), r && (l.loose = !0), v = void 0, (m = /^\[[ xX]\] /.test(s)) && (v = " " !==
							s[1], s = s.replace(/^\[[ xX]\] +/, "")), u = {
					...
					else if (t && (i = this.rules.def.exec(e))) e = e.substring(i[0].length), i[3] && (i[3] = i[3].substring(1, i[3]
						.length - 1)), h = i[1].toLowerCase().replace(/\s+/g, " "), this.tokens.links[h] || (this.tokens.links[h] = {
						href: i[2],
						title: i[3]
					});
			...
			function u(e, t) {
				if (this.options = t || m.defaults, this.links = e, this.rules = n.normal, this.renderer = this.options.renderer ||
					new r, this.renderer.options = this.options, !this.links) throw new Error(
					"Tokens array requires a `links` property.");
				this.options.pedantic ? this.rules = n.pedantic : this.options.gfm && (this.options.breaks ? this.rules = n.breaks :
					this.rules = n.gfm)
			}
			...
			function c(e) {
				this.tokens = [], this.token = null, this.options = e || m.defaults, this.options.renderer = this.options.renderer ||
			...
			function a(e, t, n) {
				...
				t && !s.test(n) && (n = function(e, t) {
					...
					return e = o[" " + e], "//" === t.slice(0, 2) ? e.replace(/:[\s\S]*/, ":") + t : "/" === t.charAt(0) ? e.replace(
						/(:\/*[^/]*)[\s\S]*/, "$1") + t : e + t
				}(t, n));
				try {
			...
			n._punctuation = "!\"#$%&'()*+,\\-./:;<=>?@\\[^_{|}~", n.em = e(n.em).replace(/punctuation/g, n._punctuation).getRegex(),
				n._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g, n._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, n._email =
				/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/,
				n.autolink = e(n.autolink).replace("scheme", n._scheme).replace("email", n._email).getRegex(), n._attribute =
				/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/, n.tag = e(n.tag).replace("comment",
					b._comment).replace("attribute", n._attribute).getRegex(), n._label =
				/(?:\[[^\[\]]*\]|\\.|`[^`]*`|[^\[\]\\`])*?/, n._href = /<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*/, n._title =
				/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, n.link = e(n.link).replace("label", n._label).replace(
					"href", n._href).replace("title", n._title).getRegex(), n.reflink = e(n.reflink).replace("label", n._label).getRegex(),
				n.normal = h({}, n), n.pedantic = h({}, n.normal, {
					...
					for (var t, n, r, i, a, o, s = ""; e;)
						...
						this.inRawBlock = !0 : this.inRawBlock && /^<\/(pre|code|kbd|script)(\s|>)/i.test(a[0]) && (this.inRawBlock = !
							1), e = e.substring(a[0].length), s += this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(
							a[0]) : k(a[0]) : a[0];
						...
						e = e.substring(a[0].length), this.inLink = !0, r = a[2], i = this.options.pedantic ? (t =
								/^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(r)) ? (r = t[1], t[3]) : "" : a[3] ? a[3].slice(1, -1) : "", r = r.trim()
							.replace(/^<([\s\S]*)>$/, "$1"), s += this.outputLink(a, {
								href: u.escapes(r),
								title: u.escapes(i)
							}), this.inLink = !1
					...
					} else if (a = this.rules.strong.exec(e)) e = e.substring(a[0].length), s += this.renderer.strong(this.output(a[
						4] || a[3] || a[2] || a[1]));
					else if (a = this.rules.em.exec(e)) e = e.substring(a[0].length), s += this.renderer.em(this.output(a[6] || a[5] ||
						a[4] || a[3] || a[2] || a[1]));
					else if (a = this.rules.code.exec(e)) e = e.substring(a[0].length), s += this.renderer.codespan(k(a[2].trim(), !
						0));
					...
					else if (a = this.rules.autolink.exec(e)) e = e.substring(a[0].length), r = "@" === a[2] ? "mailto:" + (n = k(
						this.mangle(a[1]))) : n = k(a[1]), s += this.renderer.link(r, null, n);
					else if (this.inLink || !(a = this.rules.url.exec(e))) {
						if (a = this.rules.text.exec(e)) e = e.substring(a[0].length), this.inRawBlock ? s += this.renderer.text(this.options
							.sanitize ? this.options.sanitizer ? this.options.sanitizer(a[0]) : k(a[0]) : a[0]) : s += this.renderer.text(
							k(this.smartypants(a[0])));
						else if (e) throw new Error("Infinite loop on byte: " + e.charCodeAt(0))
					} else {
					...
					return this.options.smartypants ? e.replace(/---/g, "—").replace(/--/g, "–").replace(/(^|[-\u2014/(\[{"\s])'/g,
						"$1‘").replace(/'/g, "’").replace(/(^|[-\u2014/(\[{\u2018\s])"/g, "$1“").replace(/"/g, "”").replace(/\.{3}/g,
						"…") : e
					...
					return r ? '<pre><code class="' + this.options.langPrefix + k(r, !0) + '">' + (n ? e : k(e, !0)) +
					...
					return this.options.headerIds ? "<h" + t + ' id="' + this.options.headerPrefix + r.slug(n) + '">' + e + "</h" +
						t + ">\n" : "<h" + t + ">" + e + "</h" + t + ">\n"
					...
					switch (this.token.type) {
						...
						case "table":
							var e, t, n, r, i = "",
								a = "";
							for (n = "", e = 0; e < this.token.header.length; e++) n += this.renderer.tablecell(this.inline.output(this.token
								.header[e]), {
								header: !0,
					...
					var t = e.toLowerCase().trim().replace(/[\u2000-\u206F\u2E00-\u2E7F\\'!"#$%&()*+,./:;<=>?@[\]^`{|}~]/g, "").replace(
						/\s/g, "-");
			...
			function m(e, n, r) {
				...
				if (r || "function" == typeof n) {
					...
					if (e.message += "\nPlease report this to https://github.com/markedjs/marked.", (n || m.defaults).silent) return "<p>An error occurred:</p><pre>" +
						k(e.message + "", !0) + "</pre>";
					throw e
				}
			}
			p.exec = p, m.options = m.setOptions = function(e) {
				...
				}, m.defaults = m.getDefaults(), m.Parser = c, m.parser = c.parse, m.Renderer = r, m.TextRenderer = i, m.Lexer =
				l, m.lexer = l.lex, m.InlineLexer = u, m.inlineLexer = u.output, m.Slugger = t, m.parse = m, v.exports = m
		}()
	});
	...
	function st(e, t) {
		...
		return e.forEach(function(e) {
			n += '<li><a class="section-link" href="' + e.slug + '">' + e.title + "</a></li>", e.children && (n += st(e.children,
				t))
		}), t.replace("{inner}", n)
	}
	...
	function ht(e) {
		...
		var t = e.trim().replace(/[A-Z]+/g, dt).replace(/<[^>\d]+>/g, "").replace(pt, "").replace(/\s/g, "-").replace(/-+/g,
				"-").replace(/^(\d)/, "_$1"),
			n = ut[t];
	...
	var mt, vt = at(function(e) {
		var c = function(c) {
			var u = /\blang(?:uage)?-([\w-]+)\b/i,
				...
				F = {
					...
					util: {
						encode: function(e) {
							return e instanceof O ? new O(e.type, F.util.encode(e.content), e.alias) : Array.isArray(e) ? e.map(F.util.encode) :
						...
						DFS: function e(t, n, r, i) {
							...
							for (var o in t)
								if (t.hasOwnProperty(o)) {
									...
									var s = t[o],
										l = F.util.type(s);
									"Object" !== l || i[a(s)] ? "Array" !== l || i[a(s)] || (i[a(s)] = !0, e(s, n, o, i)) : (i[a(s)] = !0, e(s,
										n, null, i))
								}
						}
					},
					...
					highlightAllUnder: function(e, t, n) {
						...
						F.hooks.run("before-highlightall", r), r.elements = Array.prototype.slice.apply(r.container.querySelectorAll(
							r.selector)), F.hooks.run("before-all-elements-highlight", r);
					...
					highlightElement: function(e, t, n) {
						...
						var a = e.parentNode;
						a && "pre" === a.nodeName.toLowerCase() && (a.className = a.className.replace(u, "").replace(/\s+/g, " ") +
							" language-" + r);
						var o = {
							element: e,
							language: r,
						...
						function s(e) {
							o.highlightedCode = e, F.hooks.run("before-insert", o), o.element.innerHTML = o.highlightedCode, F.hooks.run(
								"after-highlight", o), F.hooks.run("complete", o), n && n.call(o.element)
						}
					...
					highlight: function(e, t, n) {
						...
						return F.hooks.run("before-tokenize", r), r.tokens = F.tokenize(r.code, r.grammar), F.hooks.run(
							"after-tokenize", r), O.stringify(F.util.encode(r.tokens), r.language)
					},
									...
									for (var v = r, y = i; v < t.length; y += t[v].length, ++v) {
										...
										if (!(b instanceof O)) {
											if (h && v != t.length - 1) {
												...
												for (var k = S.index + (d && S[1] ? S[1].length : 0), x = S.index + S[0].length, w = v, _ = y, A = t.length; w <
													A && (_ < x || !t[w].type && !t[w - 1].greedy); ++w)(_ += t[w].length) <= k && (++v, y = _);
											...
											if (S) {
												...
												if (C.push(R), L && C.push(L), Array.prototype.splice.apply(t, C), 1 != T && F.matchGrammar(e, t, n, v,
														y, !0, s + "," + c), a) break
											} else if (a) break
										}
									}
			...
			if (c.Prism = F, O.stringify = function(e, t) {
					...
					return "<" + n.tag + ' class="' + n.classes.join(" ") + '"' + (i ? " " + i : "") + ">" + n.content + "</" + n.tag +
						">"
				}, !c.document) return c.addEventListener && (F.disableWorkerMessageHandler || c.addEventListener("message",
				function(e) {
			...
			if (e && (F.filename = e.src, e.hasAttribute("data-manual") && (F.manual = !0)), !F.manual) {
				...
				"loading" === r || "interactive" === r && e && e.defer ? document.addEventListener("DOMContentLoaded", n) :
					window.requestAnimationFrame ? window.requestAnimationFrame(n) : window.setTimeout(n, 16)
			}
			return F
		}("undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ?
			self : {});
		e.exports && (e.exports = c), void 0 !== it && (it.Prism = c), c.languages.markup = {
				...
				value: function(e, t) {
					...
					var i = {};
					i[e] = {
						pattern: RegExp(/(<__[\s\S]*?>)(?:<!\[CDATA\[[\s\S]*?\]\]>\s*|[\s\S])*?(?=<\/__>)/.source.replace(/__/g, e),
							"i"),
						lookbehind: !0,
						greedy: !0,
						inside: r
			...
			}), c.languages.xml = c.languages.extend("markup", {}), c.languages.html = c.languages.markup, c.languages.mathml =
			c.languages.markup, c.languages.svg = c.languages.markup,
			function(e) {
				var t = /("|')(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/;
				e.languages.css = {
					comment: /\/\*[\s\S]*?\*\//,
			...
			/(\b(?:class|interface|extends|implements|instanceof|new)\s+)[\w.\\]+/, c.languages.insertBefore("javascript",
				"keyword", {
					regex: {
						pattern: /((?:^|[^$\w\xA0-\uFFFF."'\])\s])\s*)\/(?:\[(?:[^\]\\\r\n]|\\.)*]|\\.|[^/\\\[\r\n])+\/[gimyus]{0,6}(?=(?:\s|\/\*[\s\S]*?\*\/)*(?:$|[\r\n,.;:})\]]|\/\/))/,
						lookbehind: !0,
			...
			}), c.languages.markup && c.languages.markup.tag.addInlined("script", "javascript"), c.languages.js = c.languages.javascript,
					...
					Array.prototype.slice.call(e.querySelectorAll("pre[data-src]")).forEach(function(e) {
						if (!e.hasAttribute("data-src-loaded")) {
							...
							s.open("GET", n, !0), s.onreadystatechange = function() {
								4 == s.readyState && (s.status < 400 && s.responseText ? (o.textContent = s.responseText, c.highlightElement(
										o), e.setAttribute("data-src-loaded", "")) : 400 <= s.status ? o.textContent = "✖ Error " + s.status +
									" while fetching file: " + s.statusText : o.textContent = "✖ Error: File does not exist or is empty")
							}, s.send(null)
						}
					})
							...
							if ("string" == typeof r || r.content && "string" == typeof r.content) {
								...
								if (-1 < l) {
									...
									var c = o.substring(0, l),
										...
										d = [];
									c && d.push.apply(d, e([c])), d.push(u), p && d.push.apply(d, e([p])), "string" == typeof r ? t.splice.apply(
										t, [n, 1].concat(d)) : r.content = d
								}
	...
	var bt = {},
		...
		xt = function(i, e) {
			var a = this;
			this.config = i, this.router = e, this.cacheTree = {}, this.toc = [], this.cacheTOC = {}, this.linkTarget = i.externalLinkTarget ||
				"_blank", this.linkRel = "_blank" === this.linkTarget ? i.externalLinkRel || "noopener" : "", this.contentBase = e.getBasePath();
				...
				var r = !0,
					e = s(function(e) {
						...
						return n ? (t = c(n) ? o(n) : o.parser(n), t = i.noEmoji ? t : function(e) {
							return e.replace(/:\+1:/g, ":thumbsup:").replace(/:-1:/g, ":thumbsdown:").replace(
	...
	xt.prototype.compileEmbed = function(e, t) {
		...
		if (t = i, a.include) {
			var o;
			if (Q(e) || (e = re(this.contentBase, ee(this.router.getCurrentPath()), e)), a.type && (o = kt[a.type]))(n = o.call(
				this, e, t)).type = a.type;
			else {
				var s = "code";
				/\.(md|markdown)/.test(e) ? s = "markdown" : /\.mmd/.test(e) ? s = "mermaid" : /\.html?/.test(e) ? s = "iframe" :
					/\.(mp4|ogg)/.test(e) ? s = "video" : /\.mp3/.test(e) && (s = "audio"), (n = kt[s].call(this, e, t)).type = s
			}
		...
		return i.heading = e.heading = function(e, t) {
			...
			return a.slug = s, c.toc.push(a), "<h" + t + ' id="' + o + '"><a href="' + s + '" data-id="' + o +
				'" class="anchor"><span>' + r + "</span></a></h" + t + ">"
		}, i.code = function(e) {
			return e.renderer.code = function(e, t) {
				void 0 === t && (t = "");
				var n = vt.languages[t] || vt.languages.markup;
				return '<pre v-pre data-lang="' + t + '"><code class="lang-' + t + '">' + vt.highlight(e.replace(/@DOCSIFY_QM@/g,
					"`"), n) + "</code></pre>"
			}
		}({
			renderer: e
			...
			return t.link = function(e, t, n) {
				...
				var r = [],
					...
					a = i.str,
					o = i.config;
				return l = o.target || l, c = "_blank" === l ? u.config.externalLinkRel || "noopener" : "", t = a, Q(e) || u._matchNotCompileLink(
						e) || o.ignore ? (!Q(e) && e.startsWith("./") && (e = document.URL.replace(/\/(?!.*\/).*/, "/").replace("#/./",
						"") + e), r.push(0 === e.indexOf("mailto:") ? "" : 'target="' + l + '"'), r.push(0 === e.indexOf("mailto:") ?
						"" : "" !== c ? ' rel="' + c + '"' : "")) : (e === u.config.homepage && (e = "README"), e = s.toURL(e, null, s
						.getCurrentPath())), o.crossorgin && "_self" === l && "history" === u.config.routerMode && -1 === u.config.crossOriginLinks
					.indexOf(e) && u.config.crossOriginLinks.push(e), o.disabled && (r.push("disabled"), e = "javascript:void(0)"),
					o.class && r.push('class="' + o.class + '"'), o.id && r.push('id="' + o.id + '"'), t && r.push('title="' + t +
						'"'), '<a href="' + e + '" ' + r.join(" ") + ">" + n + "</a>"
			}
		}({
			renderer: e,
			...
			return t.image = function(e, t, n) {
				...
				return s.class && i.push('class="' + s.class + '"'), s.id && i.push('id="' + s.id + '"'), Q(e) || (r = re(p, ee(
					d.getCurrentPath()), e)), 0 < i.length ? '<img src="' + r + '" data-origin="' + e + '" alt="' + n + '" ' + i.join(
			...
			return e.renderer.list = function(e, t, n) {
				var r = t ? "ol" : "ul";
				return "<" + r + " " + [/<li class="task-list-item">/.test(e.split('class="task-list"')[0]) ?
					'class="task-list"' : "", n && 1 < n ? 'start="' + n + '"' : ""
				].join(" ").trim() + ">" + e + "</" + r + ">"
			}
		}({
			renderer: e
			...
			return e.renderer.listitem = function(e) {
				return /^(<input.*type="checkbox"[^>]*>)/.test(e) ? '<li class="task-list-item"><label>' + e + "</label></li>" :
					"<li>" + e + "</li>"
			}
		}({
			renderer: e
						...
						if (e)
							if ("markdown" === a.embed.type) {
								...
								n.pop(), n = n.join("/"), e = e.replace(/\[([^[\]]+)\]\(([^)]+)\)/g, function(e) {
										var t = e.indexOf("(");
										return e.substring(t).startsWith("(.") ? e.substring(0, t) + "(" + window.location.protocol + "//" +
											window.location.host + n + "/" + e.substring(t + 1, e.length - 1) + ")" : e
									}), !0 === (($docsify.frontMatter || {}).installed || !1) && (e = $docsify.frontMatter.parseMarkdown(e)), t =
									s.lexer(e)
	...
	function Et(e) {
		e = e || "<h1>404 - Not found</h1>", this._renderTo(".markdown-section", e), this.config.loadSidebar || this._renderSidebar(),
			!1 === this.config.executeScript || void 0 === window.Vue || St() ? this.config.executeScript && St() : setTimeout(
				function(e) {
	...
	function Lt(e) {
		...
		if (i) {
			if (t.repo && (a += function(e, t) {
					return e ? (/\/\//.test(e) || (e = "https://github.com/" + e), '<a href="' + (e = e.replace(/^git\+/, "")) +
						'" target="' + (t = t || "_blank") +
					...
					var e = ", 100%, 85%";
					return '<section class="cover show" style="background: ' + ("linear-gradient(to left bottom, hsl(" + Math.floor(
							255 * Math.random()) + e + ") 0%,hsl(" + Math.floor(255 * Math.random()) + e + ") 100%)") +
			...
			a += function(e) {
				var t = e.name ? e.name : "",
					...
					(e.name ? '<h1 class="app-name"><a class="app-name-link" data-nosearch>' + (e.logo ? '<img alt="' + t + '" src=' +
						e.logo + ">" : t) + "</a></h1>" : "") + '<div class="sidebar-nav">\x3c!--sidebar--\x3e</div></aside>';
				return (f ? n + "<main>" : "<main>" + n) +
					'<section class="content"><article class="markdown-section" id="main">\x3c!--main--\x3e</article></section></main>'
			}(t), e._renderTo(i, a, !0)
		} else e.rendered = !0;
		t.mergeNavbar && f ? o = y(".sidebar") : (r.classList.add("app-nav"), t.repo || r.classList.add("no-badge")), t.loadNavbar &&
			k(o, r), t.themeColor && (u.head.appendChild(g("div", function(e) {
	...
	Rt.prototype.getBasePath = function() {
			...
			return e = (e = function(e, t) {
				return new RegExp("\\.(" + t.replace(/^\./, "") + "|html)$", "g").test(e) ? e : /\/$/g.test(e) ? e + "README" + t :
					"" + e + t
			...
			}(e, n.alias) : e, i)) === "/README" + i && n.homepage || e, e = Q(e) ? e : re(r, e), t && (e = e.replace(new RegExp(
				"^" + r), "")), e
		}, Rt.prototype.onchange = function(e) {
			void 0 === e && (e = p), e()
		}, Rt.prototype.getCurrentPath = function() {}, Rt.prototype.normalize = function() {}, Rt.prototype.parse = function() {},
	...
	var Ot = function(r) {
			...
			return r && (e.__proto__ = r), ((e.prototype = Object.create(r && r.prototype)).constructor = e).prototype.getBasePath =
				function() {
		...
		$t = function(t) {
			...
			return t && (e.__proto__ = t), ((e.prototype = Object.create(t && t.prototype)).constructor = e).prototype.getCurrentPath =
				function() {
	...
	function zt(e) {
		...
		function(e) {
			null != (e = m(e)) && x(e, "click", function(e) {
				var t = e.target;
				"A" === t.nodeName && t.nextSibling && t.nextSibling.classList && t.nextSibling.classList.contains(
					"app-sub-sidebar") && _(t.parentNode, "collapse")
			})
		}(".sidebar", e.router), e.config.coverpage ? f || x("scroll", W) : v.classList.add("sticky")
	}

	function Pt(t, n, r, i, a, e) {
		t = e ? t : t.replace(/\/$/, ""), (t = ee(t)) && I(a.router.getFile(t + r) + n, !1, a.config.requestHeaders).then(i,
			function(e) {
				return Pt(t, n, r, i, a)
			})
	}
	...
	Ut._init = function() {
		...
		e.config = S(e),
			function(n) {
				n._hooks = {}, n._lifecycle = {}, ["init", "mounted", "beforeEach", "afterEach", "doneEach", "ready"].forEach(
					function(e) {
						var t = n._hooks[e] = [];
			...
			function(t) {
				var e, n = t.config;
				e = "history" === (n.routerMode || "hash") && i ? new $t(n) : new Ot(n), t.router = e, Nt(t), Mt = t.route, e.onchange(
					function(e) {
						Nt(t), t._updateRender(), Mt.path !== t.route.path ? (t.$fetch(p, t.$resetEvents.bind(t, e.source)), Mt = t.route) :
			...
			function(t) {
				...
				if (t.rendered) {
					...
					e && n && (n.parentNode.innerHTML += window.__SUB_SIDEBAR__), t._bindEventOnRendered(n), t.$resetEvents(), B(t,
						"doneEach"), B(t, "ready")
		...
		var t = this.config,
			...
			r = t.subMaxLevel,
			i = t.loadSidebar;
		if (t.hideSidebar) return document.querySelector("aside.sidebar").remove(), document.querySelector(
				"button.sidebar-toggle").remove(), document.querySelector("section.content").style.right = "unset", document.querySelector(
				"section.content").style.left = "unset", document.querySelector("section.content").style.position = "relative",
			document.querySelector("section.content").style.width = "100%", null;
		this._renderTo(".sidebar-nav", this.compiler.sidebar(e, n));
		var a = G(this.router, ".sidebar-nav", !0, !0);
		i && a ? a.parentNode.innerHTML += this.compiler.subSidebar(r) || "" : this.compiler.subSidebar(), this._bindEventOnRendered(
			a)
		...
		if (_(m("main"), t ? "add" : "remove", "hidden"), e) {
			...
			if (i) {
				if ("color" === i[2]) n.style.background = i[1] + (i[3] || "");
					...
					var a = i[1];
					_(n, "add", "has-mask"), Q(i[1]) || (a = re(this.router.getBasePath(), i[1])), n.style.backgroundImage = "url(" +
						a + ")", n.style.backgroundSize = "cover", n.style.backgroundPosition = "center center"
				}
				r = r.replace(i[0], "")
			}
		...
		this.isRemoteUrl = function(e) {
			var t = e.match(/^([^:\/?#]+:)?(?:\/\/([^\/?#]*))?([^?#]+)?(\?[^#]*)?(#.*)?/);
			return "string" == typeof t[1] && 0 < t[1].length && t[1].toLowerCase() !== location.protocol || "string" ==
				typeof t[2] && 0 < t[2].length && t[2].replace(new RegExp(":(" + {
					"http:": 80,
					"https:": 443
		...
		if (n) {
			...
			return o ? (o = this.router.getFile(a + o), this.coverIsHTML = /\.html$/g.test(o), I(o + K(i, ["id"]), !1, r).then(
				function(e) {
		...
		void 0 === e && (e = p), void 0 === t && (t = this.$resetEvents.bind(this)), this._fetchCover() ? r() : this._fetch(
			function() {
				t(), r()
			})
